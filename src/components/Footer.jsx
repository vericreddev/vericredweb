        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-light hover:text-accent transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-light hover:text-accent transition-colors">{t('footer.aboutUs')}</a></li>
                <li><a href="#roadmap" className="text-light hover:text-accent transition-colors">{t('footer.roadmap')}</a></li>
                <li><a href="#" className="text-light hover:text-accent transition-colors">{t('footer.contact')}</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white font-semibold mb-4">{t('footer.resources')}</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-light hover:text-accent transition-colors">{t('footer.whitepaper')}</a></li>
