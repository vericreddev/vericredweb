      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          {socialLinks.map((social, index) => (
            <motion.a
              ...
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-secondary/50 to-secondary/20 backdrop-blur-sm border border-accent/20 p-8 hover:border-accent/40 transition-all duration-300"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-accent">{social.followers}</div>
                    <div className="text-sm text-light">{t('community.followers')}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center text-accent group-hover:translate-x-2 transition-transform duration-300">
                  <span className="mr-2">{t('community.joinNow')}</span>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://discord.gg/vericred"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://twitter.com/VeriCred_"
              target="_blank"
              rel="noopener noreferrer"
