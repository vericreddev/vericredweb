...
const Community = () => {
  ...
  const handlePlatformClick = (platformName, url) => {
    if (platformName === 'Twitter' || platformName === 'Discord' || platformName === 'Telegram' || platformName === 'Medium') {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: 'https://discord.gg/uZAg6Sg39e',
    ...
    },
    {
      ...
      url: 'https://medium.com/@VeriCred24',
  ...
  return (
    <div id="community" className="bg-primary text-white py-20">
      {/* Coming Soon Modal */}
      {showComingSoon && (
        <motion.div
          initial={{ opacity: 0 }}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-accent via-blue-400 to-purple-400 bg-clip-text text-transparent">
            {t('community.title')}
          </h1>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center text-accent group-hover:translate-x-2 transition-transform duration-300">
                  <span className="mr-2">{['Twitter', 'Discord', 'Telegram', 'Medium'].includes(social.name) ? t('community.visitNow') : t('community.comingSoon')}</span>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={['Twitter', 'Discord', 'Telegram', 'Medium'].includes(social.name) ? "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" : "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"} />
                  </svg>
                </div>
              </div>
            </motion.div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-white">{t('community.stats.title')}</h2>
            <p className="text-light text-lg">{t('community.stats.description')}</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { number: '20K+', label: t('community.stats.totalMembers') },
              { number: '50+', label: t('community.stats.countries') },
              { number: '100+', label: t('community.stats.dailyActive') },
              ...
              <motion.div
                ...
                className="text-center p-6 rounded-2xl bg-gradient-to-br from-secondary/30 to-secondary/10 backdrop-blur-sm border border-accent/20"
              >
                <div className="text-3xl md:text-4xl font-bold text-accent mb-2">{stat.number}</div>
                <div className="text-light text-sm md:text-base">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="text-center bg-gradient-to-br from-secondary/30 to-secondary/10 backdrop-blur-sm border border-accent/20 rounded-3xl p-12"
        >
          <h2 className="text-4xl font-bold mb-6 text-white">{t('community.cta.title')}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => handlePlatformClick('Discord', 'https://discord.gg/uZAg6Sg39e')}
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => handlePlatformClick('Telegram', 'https://t.me/VeriCred')}
              className="btn btn-accent flex items-center justify-center gap-3"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
              </svg>
              {t('community.cta.joinTelegram')}
            </motion.button>
            
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => handlePlatformClick('Medium', 'https://medium.com/@VeriCred24')}
              className="btn btn-outline flex items-center justify-center gap-3"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"/>
              </svg>
              {t('community.cta.readMedium')}
            </motion.button>
          </div>
        </motion.div>
      </div>
